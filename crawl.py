...
class Scrape:
    ...
    def __init__(self, *args):
        ...
        # modified when scraping another [ item_number ]...
        self.num = ("2956")
    ...
    def scrape_data(self, *args):
        ...
        for i in range(int(page), 400000):
            url = ("https://mavin.io/search?q=&amp;bt=sold&amp;cat=" +
                   self.num + "&amp;sort=EndTimeSoonest&amp;page="+str(i))
            ...
            try:
                ...
                for tags in divtags:
                    ...
                    shipping_cost = tags.find(
                        "h3", class_="sold-price")["data-shipping"]
                    self.save_data(name, price, image,
                                   date_sold, shipping_cost)
    ...
    def reload(self):
        with open("log.txt", "r") as page_file:
            page = page_file.read()
            page = int(page)
